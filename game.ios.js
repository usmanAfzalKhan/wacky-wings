...
function checkCollision() {
  for (const pipe of pipes) {
    const withinX = bird.x + bird.width > pipe.x + 7 && bird.x < pipe.x + pipeWidth - 7;
    const hitsTop = bird.y + 3 < pipe.topY;
    const hitsBottom = bird.y + bird.height - 3 > pipe.bottomY;
